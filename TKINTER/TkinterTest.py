...
elsosor = tk.Label(root, text="Press a key...")
elsosor.pack(padx=10, pady=10)
masodiksor = tk.Label(root, text="Press a key...")
masodiksor.pack(padx=10, pady=10)
harmadiksor = tk.Label(root, text="Press a key...")
harmadiksor.pack(padx=10, pady=10)
negyediksor = tk.Label(root, text="Press a key...")
negyediksor.pack(padx=10, pady=10)


def szovegfrissites():
    elsosor.config(text=f"SÚGÓ: {sugo}")
    masodiksor.config(text=f"MODE: {mode}")
    harmadiksor.config(text=f"PVW: {PVW}")
    negyediksor.config(text=f"PVW: {PGM}")
...
if not atem4K.connected or not atemMini.connected:
    consoleText()
